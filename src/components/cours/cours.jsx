          ...
          <div className="sidebar">
            ...
            <ul>
              ...
              {downloadedFiles.map((downloadedFile) => (
                <>
                  <li
                    ...
                    className={
                      selectedDepartment === "technologie" ? "selected" : ""
                    }
                  >
                    {downloadedFile}
                  </li>
              ...
              <li
                ...
                className={
                  selectedDepartment === "Informatique" ? "selected" : ""
                }
              >
                physique
              </li>
              ...
              <li
                ...
                className={
                  selectedDepartment === "mathematique" ? "selected" : ""
                }
              >
                Mathematique
              </li>
